...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&width=600&lines=Backend+Developer+%F0%9F%9A%80;Node.js+%7C+NestJS+%7C+ASP.NET+Core;Building+scalable+APIs+%26+systems;Always+learning%2C+always+shipping+%E2%9C%A8" alt="Typing SVG" />

<br/>

[![Profile Views](https://komarev.com/ghpvc/?username=dilanderegozu&label=Profile%20Views&color=58A6FF&style=flat-square)](https://github.com/dilanderegozu)
...
```typescript
const dilan: Developer = {
  name: "Dilan Deregözü",
  role: "Backend Developer",
  location: "Turkey 🇹🇷",
  currentFocus: ["ASP.NET Core", "C#", "Microservices"],
  stack: ["Node.js", "NestJS", "Express.js", "React"],
  databases: ["PostgreSQL", "MongoDB", "MySQL", "SQL Server"],
  cloud: ["Azure"],
  askMeAbout: ["REST APIs", "Backend Architecture", "Database Design"],
